...
<html lang="en">
  <head>
    ...
    <title>Trending Posts | chiiirp </title>
...
<button class="btn btn-default login" id="toTop"> <i class="fa fa-arrow-up size" aria-hidden="true"></i> </button>
  ...
  <div class="col-lg-1 col-md-1"></div>
	 ...
	 $sqlpost = "SELECT a.*, b.* FROM posts a LEFT JOIN vote b ON a.Post_id = b.Post_id where 	Post_time > ' ".date_format($querydate,"Y-m-d H:i:s")."' ORDER BY popu_score DESC ,a.Post_id DESC LIMIT 20 ";
...
if($result){
    ...
    <script src="js/reloader_trending.js"></script>
		<script>
