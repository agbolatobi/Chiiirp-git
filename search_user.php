...
{
	header('location:search?search='.$_GET['search'].'');
}
 ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title><?php if(isset($_GET['search'])){
			...
			echo" Search for posts | Upforposts ";
		}?></title>
...
<br />
<?php foreach ($search->searchposts($_GET['search']) as $searchid) {
	include"includes/conn.php";
	  $sqlpost = "SELECT * FROM posts where Post_id = '$searchid'  ";
