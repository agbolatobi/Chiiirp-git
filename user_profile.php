...
{
	header('location:out_profile.php?id='.$_GET['id'].'');
}
...
<button class="btn btn-default login" id="toTop"> <i class="fa fa-arrow-up size" aria-hidden="true"></i> </button>
 ...
 <div class="container-fluid">
	<div class="row"><div class="col-lg-1 col-sm-1"></div>
		<div class="col-lg-3 col-sm-3  profilebox ">
        <br />
       ...
       <input type="hidden" id="user_id" value="<?php echo json_decode( base64_decode($_GET['id'])); ?>" />
		...
		<div class="col-lg-7 col-sm-7 contentcon" id="content">
			<?php
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form action="includes/updatedesc" method="post" >
        ...
        <div class="col-md-10">
        <textarea rows="6" cols="70" name="desc" ><?php echo"".$userinfo["Description"].""; ?></textarea>
        <br />
    ...
    <script src="js/bootstrap.min.js"></script>
        ...
        <script src="js/user_profile_posts.js"></script>
