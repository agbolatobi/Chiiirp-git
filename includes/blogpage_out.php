...
if ($result_item->num_rows > 0)
{
  ...
  <ul class='dropdown-menu'>
	<li><a href='loginpage'>Report</a></li>
  </ul></div></div><div class=col-xs-7></div><div class=col-xs-2><p class='time'>". $time->Cal_Diff($currentdate,$row['Post_time'])."</p></div></div>"; ?>
    <?php
  echo"

          <div class=row>
        <div class=col-sm-12 content>
                  <a class=title href='comment_out?id=".$postid."&type=".$row['Post_type']."'><h3 class=title align=center>".$row_item['Title']."</h3></a>
                      <p class='postext'> ". nl2br ($row_item['Description'])."
        </div>
                  </div>
        ...
        echo"<a href='out_profile?id=".base64_encode(json_encode($row['User_id']))."'>".$userinfo['Username']."</a>";}
        ?>
		<?php echo"
          </div></div>
         ...
         echo"
                  ...
                  <a class=bottomcontent href='loginpage' >   <i class='fa fa-thumbs-up size' aria-hidden='true'></i>
</a><br />
        <p id=".'upnumber'.$postid.">".$vote->getUpvote($postid)."</p>
                  </div>
                  <div class='col-sm-1 col-xs-2'>
                  <a class=bottomcontent  href='loginpage' > <i class='fa fa-thumbs-down size' aria-hidden='true'></i></a><br />
        ...
        echo" <div class='col-sm-1 col-xs-2'>
                    <a class='bottomcontent' href='comment_out?id=".$postid."&type=".$row['Post_type']."'><i class='fa fa-comment size' aria-hidden='true'></i></a>
					  <br />
...
if ($result_item->num_rows > 0)
{
  ...
  echo'
          ...
          <div class="row">
        <div class="col-sm-12 content">
                 <a class=title href="comment_out?id='.$postid."&type=".$row['Post_type'].'"> <h2 class="title" align="center">'.$row_item['Audio_title'].'</h2></a>
        <div align="center">
...
if ($result_item->num_rows > 0)
{
  ...
  echo'
        ...
        <div class="col-sm-10 content" align="center">
                 <a class=title href="comment_out?id='.$postid.'&type='.$row['Post_type'].'"> <h3 class="title" align="center">'.$row_item['video_title'].'</h3></a>
         <video preload="none" class="img-responsive" controls>
...
if ($result_item->num_rows > 0)
{
  ...
  echo'
        ...
        <div class="col-sm-12 content" align="center">
                  <a class=title href="comment_out?id='.$postid.'&type='.$row['Post_type'].'"><h3 class="title" align="center">'.$row_item['Image_title'].'</h3></a>
  <img src="'.$row_item['Image_link'].'" class="img-responsive" alt="'.$row_item['Image_title'].'"  />
                      <p></p>
        </div>
        ';
        echo'
