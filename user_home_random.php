...
<html lang="en">
  <head>
    ...
    <title>Random Posts | chiiirp</title>
 ...
 <div class="container-fluid">
  ...
  <div class="col-lg-1 col-md-1"></div>
    ...
    <?php include"includes/searchbox_user.php" ?>
	 ...
	 $sqlpost = "SELECT * FROM posts ORDER BY RAND() LIMIT 20 ";
...
if($result){
    ...
    <script src="js/user_reloader_random.js"></script>
