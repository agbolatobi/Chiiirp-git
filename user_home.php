...
<html lang="en">
  <head>
    ...
    <title>Trending posts | Upforposts</title>
 ...
 <div class="container-fluid">
  ...
  <div class="col-lg-1 col-md-1"></div>
    ...
    <?php include"includes/searchbox_user.php" ?>
	 ...
	 $sqlpost = "SELECT a.*, b.* FROM posts a LEFT JOIN vote b ON a.Post_id = b.Post_id where 	Post_time > ' ".date_format($querydate,"Y-m-d H:i:s")."' ORDER BY popu_score DESC, Post_time DESC, a.Post_id DESC LIMIT 20";
...
include"includes/blogpage_user.php";
    ...
    <script src="js/user_reloader_trending.js"></script>
